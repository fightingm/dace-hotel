...
import { getElementOffsetY, getOnlyChild } from '../common/utils';
import classNames from 'classnames';
import throttle from 'lodash/throttle';
import { isEnvNode } from '../common/utils';
...
const { rAF, cancelrAF } = isEnvNode ? {} : utils.getRAF();
...
const defaultProps = {
    ...
    bounceEasing: isEnvNode ? null : utils.ease.circular, // 弹性滚动easing函数
